...
function ReseñasPage() {
  ...
  return (
    <div className="reviews-layout">
      {/* Header Glassmorphism (Consistente con LugaresPage) */}
      <header className="reviews-header">
        <div className="header-content">
          ...
          <div className="header-title-wrapper">
             <span className="header-subtitle">Tu Diario de Viajes</span>
      ...
      <main className="reviews-main">
        ...
        {/* Lista de Reseñas - Diseño Elegante */}
        {usuarioLogueado && !loading && !error && reseñas.length > 0 && (
              ...
              <article key={reseña.id} className="review-card">
                ...
                <div className="review-content">
                  ...
                  <div className="rating-display">
                    ...
                    <span className="rating-text">{reseña.calificacion}/5</span>
                  </div>
